...
{
	UIColor *topColor = [UIColor colorWithRed:49.0/255.0 green:249.0/255.0 blue:236.0/255.0 alpha:1];
	UIColor *bottomColor = [UIColor colorWithRed:36.0/255.0 green:123.0/255.0 blue:128.0/255 alpha:1];
[self drawRectAtULPoint:rect.origin
									 size:rect.size
								ulColor:topColor
								urColor:topColor
								llColor:bottomColor
	...
	[self produceRandomLines:77 inFrame:rect];
}

- (void)produceRandomLines:(NSUInteger)numLines inFrame:(CGRect)rect{
