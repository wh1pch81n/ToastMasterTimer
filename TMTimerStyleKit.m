...
+ (void)drawWineGauge50WithG_minSeconds: (CGFloat)g_minSeconds g_maxSeconds: (CGFloat)g_maxSeconds g_elapsedSeconds: (CGFloat)g_elapsedSeconds;
{
    ...
    UIColor* w_greenWine = g_elapsedSeconds <= 0 || g_elapsedSeconds < g_minSeconds ? g_clear : TMTimerStyleKit.g_LowPressureColor;
    UIColor* w_yellowWine = g_elapsedSeconds >= g_midSeconds ? TMTimerStyleKit.g_MediumPressureColor : g_clear;
    UIColor* w_redWine = g_elapsedSeconds >= g_maxSeconds ? TMTimerStyleKit.g_HighPressureColor : g_clear;
    UIColor* w_superRedWine = g_elapsedSeconds >= g_maxSeconds + 30 ? g_GaugeOutlineOverTime : g_clear;
    UIColor* w_wineGlass = g_elapsedSeconds == 0 ? g_clear : TMTimerStyleKit.tM_ThemeAqua;

    //// Group
    {
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, 20, 5.5);
        CGContextRotateCTM(context, 30.7 * M_PI / 180);



        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(18.5, 0.86)];
        [bezierPath addCurveToPoint: CGPointMake(16.65, 0.44) controlPoint1: CGPointMake(18.05, 0.71) controlPoint2: CGPointMake(17.43, 0.56)];
        [bezierPath addCurveToPoint: CGPointMake(3.35, 0.44) controlPoint1: CGPointMake(12.98, -0.15) controlPoint2: CGPointMake(7.02, -0.15)];
        [bezierPath addCurveToPoint: CGPointMake(1.5, 0.86) controlPoint1: CGPointMake(2.57, 0.56) controlPoint2: CGPointMake(1.95, 0.71)];
        bezierPath.lineCapStyle = kCGLineCapRound;

        [w_wineGlass setStroke];
        ...
        //// wines
        {
            //// greenWine Drawing
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, 2.34, 14.31);
            CGContextRotateCTM(context, -30.7 * M_PI / 180);

            UIBezierPath* greenWinePath = UIBezierPath.bezierPath;
            [greenWinePath moveToPoint: CGPointMake(18.51, 0)];
            [greenWinePath addCurveToPoint: CGPointMake(10.35, 9.35) controlPoint1: CGPointMake(16.94, 3.99) controlPoint2: CGPointMake(13.92, 7.62)];
            [greenWinePath addCurveToPoint: CGPointMake(0.01, 3.21) controlPoint1: CGPointMake(4.93, 11.98) controlPoint2: CGPointMake(0.3, 9.23)];
            [greenWinePath addCurveToPoint: CGPointMake(0.25, 0) controlPoint1: CGPointMake(-0.04, 2.16) controlPoint2: CGPointMake(0.05, 1.08)];
            [greenWinePath addLineToPoint: CGPointMake(18.51, 0)];
            [greenWinePath closePath];
            [w_greenWine setFill];
            [greenWinePath fill];
            ...
            //// yellowWine Drawing
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, 1.32, 12.59);
            CGContextRotateCTM(context, -30.7 * M_PI / 180);

            UIBezierPath* yellowWinePath = UIBezierPath.bezierPath;
            [yellowWinePath moveToPoint: CGPointMake(19.16, 0)];
            [yellowWinePath addCurveToPoint: CGPointMake(10.35, 11.35) controlPoint1: CGPointMake(17.92, 4.74) controlPoint2: CGPointMake(14.5, 9.33)];
            [yellowWinePath addCurveToPoint: CGPointMake(0.01, 5.21) controlPoint1: CGPointMake(4.93, 13.98) controlPoint2: CGPointMake(0.3, 11.23)];
            [yellowWinePath addCurveToPoint: CGPointMake(0.76, 0) controlPoint1: CGPointMake(-0.07, 3.51) controlPoint2: CGPointMake(0.21, 1.73)];
            [yellowWinePath addLineToPoint: CGPointMake(19.16, 0)];
            [yellowWinePath closePath];
            [w_yellowWine setFill];
            [yellowWinePath fill];
            ...
            //// redWine Drawing
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, -0.22, 10.01);
            CGContextRotateCTM(context, -30.7 * M_PI / 180);

            UIBezierPath* redWinePath = UIBezierPath.bezierPath;
            [redWinePath moveToPoint: CGPointMake(18.77, 0)];
            [redWinePath addCurveToPoint: CGPointMake(21.3, 0.75) controlPoint1: CGPointMake(18.77, 0) controlPoint2: CGPointMake(20.7, 0.25)];
            [redWinePath addCurveToPoint: CGPointMake(19.55, 1.03) controlPoint1: CGPointMake(21.89, 1.25) controlPoint2: CGPointMake(19.59, 0.69)];
            [redWinePath addCurveToPoint: CGPointMake(10.35, 14.35) controlPoint1: CGPointMake(18.85, 6.43) controlPoint2: CGPointMake(15.08, 12.05)];
            [redWinePath addCurveToPoint: CGPointMake(0.01, 8.21) controlPoint1: CGPointMake(4.93, 16.98) controlPoint2: CGPointMake(0.3, 14.23)];
            [redWinePath addCurveToPoint: CGPointMake(2.02, 0) controlPoint1: CGPointMake(-0.11, 5.51) controlPoint2: CGPointMake(0.65, 2.61)];
            [redWinePath addLineToPoint: CGPointMake(18.77, 0)];
            [redWinePath closePath];
            redWinePath.lineCapStyle = kCGLineCapRound;
            ...
            //// superRedWine Drawing
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, -1.18, 8.39);
            CGContextRotateCTM(context, -30.7 * M_PI / 180);

            UIBezierPath* superRedWinePath = UIBezierPath.bezierPath;
            [superRedWinePath moveToPoint: CGPointMake(22.3, 1.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(25.3, 3.89) controlPoint1: CGPointMake(22.99, 2.24) controlPoint2: CGPointMake(24.3, 2.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(26.3, 4.89) controlPoint1: CGPointMake(26.17, 4.76) controlPoint2: CGPointMake(25.72, 4.31)];
            [superRedWinePath addCurveToPoint: CGPointMake(28.21, 8.22) controlPoint1: CGPointMake(27.59, 6.18) controlPoint2: CGPointMake(28.04, 7.47)];
            [superRedWinePath addCurveToPoint: CGPointMake(28.3, 8.89) controlPoint1: CGPointMake(28.3, 8.64) controlPoint2: CGPointMake(28.3, 8.89)];
            [superRedWinePath addLineToPoint: CGPointMake(28.22, 9.65)];
            [superRedWinePath addCurveToPoint: CGPointMake(28.3, 13.89) controlPoint1: CGPointMake(28.22, 9.65) controlPoint2: CGPointMake(28.61, 10.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(27.3, 21.89) controlPoint1: CGPointMake(27.99, 16.89) controlPoint2: CGPointMake(27.3, 16.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(26.37, 27.56) controlPoint1: CGPointMake(27.3, 26.89) controlPoint2: CGPointMake(26.37, 27.56)];
            [superRedWinePath addCurveToPoint: CGPointMake(26.1, 30.1) controlPoint1: CGPointMake(26.37, 27.56) controlPoint2: CGPointMake(26.91, 27.32)];
            [superRedWinePath addCurveToPoint: CGPointMake(25.3, 37.89) controlPoint1: CGPointMake(25.3, 32.89) controlPoint2: CGPointMake(25.3, 37.89)];
            [superRedWinePath addLineToPoint: CGPointMake(24.3, 37.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(24.3, 32.89) controlPoint1: CGPointMake(24.3, 37.89) controlPoint2: CGPointMake(25.3, 35.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(24.3, 27.89) controlPoint1: CGPointMake(23.3, 29.89) controlPoint2: CGPointMake(24.3, 27.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(25.3, 18.89) controlPoint1: CGPointMake(24.3, 27.89) controlPoint2: CGPointMake(24.3, 22.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(24.3, 10.89) controlPoint1: CGPointMake(26.3, 14.89) controlPoint2: CGPointMake(24.55, 13.64)];
            [superRedWinePath addCurveToPoint: CGPointMake(24.3, 7.89) controlPoint1: CGPointMake(24.05, 8.14) controlPoint2: CGPointMake(24.3, 7.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(24.3, 7.17) controlPoint1: CGPointMake(24.3, 7.89) controlPoint2: CGPointMake(24.89, 8.46)];
            [superRedWinePath addCurveToPoint: CGPointMake(23.9, 6.74) controlPoint1: CGPointMake(23.7, 5.89) controlPoint2: CGPointMake(23.9, 6.74)];
            [superRedWinePath addLineToPoint: CGPointMake(23.3, 5.89)];
            [superRedWinePath addLineToPoint: CGPointMake(21.3, 3.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(19.52, 3.08) controlPoint1: CGPointMake(21.3, 3.89) controlPoint2: CGPointMake(19.99, 3.48)];
            [superRedWinePath addCurveToPoint: CGPointMake(10.35, 16.23) controlPoint1: CGPointMake(18.77, 8.43) controlPoint2: CGPointMake(15.03, 13.96)];
            [superRedWinePath addCurveToPoint: CGPointMake(0.01, 10.1) controlPoint1: CGPointMake(4.93, 18.86) controlPoint2: CGPointMake(0.3, 16.12)];
            [superRedWinePath addCurveToPoint: CGPointMake(2.59, 0.89) controlPoint1: CGPointMake(-0.13, 7.05) controlPoint2: CGPointMake(0.86, 3.75)];
            [superRedWinePath addCurveToPoint: CGPointMake(19.3, 0.89) controlPoint1: CGPointMake(2.59, 0.89) controlPoint2: CGPointMake(16.83, 0.89)];
            [superRedWinePath addCurveToPoint: CGPointMake(22.3, 1.89) controlPoint1: CGPointMake(19.3, 0.89) controlPoint2: CGPointMake(20.3, 0.89)];
            [superRedWinePath closePath];
            [w_superRedWine setFill];
            [superRedWinePath fill];
        ...
        [ovalPath moveToPoint: CGPointMake(9.29, 22.85)];
        [ovalPath addCurveToPoint: CGPointMake(10.71, 22.85) controlPoint1: CGPointMake(9.68, 23.05) controlPoint2: CGPointMake(10.32, 23.05)];
        [w_wineGlass setStroke];
        ...
        [bezier2Path moveToPoint: CGPointMake(8, 35.5)];
        [bezier2Path addCurveToPoint: CGPointMake(8, 22.22) controlPoint1: CGPointMake(8, 35.5) controlPoint2: CGPointMake(8, 25.08)];
        [bezier2Path addCurveToPoint: CGPointMake(2.93, 18.4) controlPoint1: CGPointMake(6.14, 21.69) controlPoint2: CGPointMake(4.37, 20.42)];
        [bezier2Path addCurveToPoint: CGPointMake(1.37, 1.43) controlPoint1: CGPointMake(-0.36, 13.8) controlPoint2: CGPointMake(-0.88, 6.79)];
        [bezier2Path addCurveToPoint: CGPointMake(3.64, 2.06) controlPoint1: CGPointMake(1.78, 1.66) controlPoint2: CGPointMake(2.54, 1.88)];
        [bezier2Path addCurveToPoint: CGPointMake(16.36, 2.06) controlPoint1: CGPointMake(7.15, 2.65) controlPoint2: CGPointMake(12.85, 2.65)];
        [bezier2Path addCurveToPoint: CGPointMake(18.63, 1.43) controlPoint1: CGPointMake(17.46, 1.88) controlPoint2: CGPointMake(18.22, 1.66)];
        [bezier2Path addCurveToPoint: CGPointMake(17.07, 18.4) controlPoint1: CGPointMake(20.88, 6.79) controlPoint2: CGPointMake(20.36, 13.8)];
        [bezier2Path addCurveToPoint: CGPointMake(12, 22.22) controlPoint1: CGPointMake(15.63, 20.42) controlPoint2: CGPointMake(13.86, 21.69)];
        [bezier2Path addCurveToPoint: CGPointMake(12, 35.5) controlPoint1: CGPointMake(12, 25.08) controlPoint2: CGPointMake(12, 35.5)];
        [bezier2Path addLineToPoint: CGPointMake(16.03, 38.61)];
        [bezier2Path addLineToPoint: CGPointMake(16.66, 39.5)];
        [bezier2Path addLineToPoint: CGPointMake(16.01, 39.5)];
        [bezier2Path addLineToPoint: CGPointMake(10, 39.5)];
        [bezier2Path addLineToPoint: CGPointMake(3.98, 39.5)];
        [bezier2Path addLineToPoint: CGPointMake(3.34, 39.5)];
        [bezier2Path addLineToPoint: CGPointMake(4.01, 38.55)];
        [bezier2Path addLineToPoint: CGPointMake(8, 35.5)];
